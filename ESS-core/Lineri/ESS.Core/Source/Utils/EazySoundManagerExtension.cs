    ...
    where TSource : class, IAudioSource
{
    ...
    public List<TAudio> GetMusicAudio(IAudioClip audioClip)
    {
    ...
    public List<TAudio> GetSoundAudio(IAudioClip audioClip)
    {
    ...
    public List<TAudio> GetUISoundAudio(IAudioClip audioClip)
    {
